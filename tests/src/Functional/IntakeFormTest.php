...
class IntakeFormTest extends SliTestBase {
  ...
  protected function fieldData($step = NULL) {
    $field_data = [
      1 => [
        ...
        'edit-stakeholder-address-state' => 'AL',
  ...
  public function testIntakeForm() {
    ...
    $expected = [
      ...
      'intake_stakeholder_state' => $field_data[1]['edit-stakeholder-address-state'],
      ...
      'intake_property_state' => $field_data[2]['edit-property-info-state'],
